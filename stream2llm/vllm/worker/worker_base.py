...
class WorkerWrapperBase:
    ...
    def initialize_from_config(
            self, kv_cache_configs: List[Any]) -> Dict[str, List[List[int]]]:
        kv_cache_config = kv_cache_configs[self.rpc_rank]
        kv_cache_infos = self.worker.initialize_from_config(
    ...
    def measure_kv_cache_swap_latency(
        ...
        return self.worker.measure_kv_cache_swap_latency(
