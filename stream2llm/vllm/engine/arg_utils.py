...
class EngineArgs:
    ...
    def _set_default_args_v1(self, usage_context: UsageContext) -> None:
        ...
        # V1 disables prefix caching by default.
        if self.enable_prefix_caching is None:
            # TODO: rbachkaniwala3 - enable prefix caching by default once swapping is implemented with prefix caching. Currently, prefix caching is not supported with swapping.
            self.enable_prefix_caching = False
