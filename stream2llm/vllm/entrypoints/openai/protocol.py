...
class CompletionPromptStreamingRequest(CompletionRequest):
    # Identical to OpenAI's official CompletionRequest, but with an extra
    # `prompt_streaming_finished` field to support input prompt streaming.
    prompt_streaming_finished: bool = False

    # `request_id` becomes optional to allow for appending/overwriting
    # prompt streaming requests
    request_id: Optional[str] = None

    # `separator`` to inject between intermediate prompt chunks when streaming
