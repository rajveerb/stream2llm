...
def bind_kv_cache(
    ...
    cpu_runner_kv_caches: Optional[list[torch.Tensor]] = None,
) -> None:
    """
    ...
    for layer_index in sorted(index2name.keys()):
        ...
        if cpu_kv_caches is not None:
            assert cpu_runner_kv_caches is not None, "cpu_runner_kv_caches must be provided if cpu_kv_caches is provided"
            cpu_runner_kv_caches.append(cpu_kv_caches[layer_name])
