...
if TYPE_CHECKING:
    ...
    VLLM_ENABLE_PROMPT_STREAMING: bool = True
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Whether to enable prompt streaming and expose the
    # `/v1/generate-prompt-streaming` endpoint in the vllm serve HTTP API.
    "VLLM_ENABLE_PROMPT_STREAMING":
    lambda: os.environ.get("VLLM_ENABLE_PROMPT_STREAMING", "1") == "1"
}
